...
class FlexiCubes:
    ...
    def _compute_reg_loss(self, vd, ue, edge_group_to_vd, vd_num_edges):
        ...
        mean_l2 = (mean_l2).index_add_(0, edge_group_to_vd, dist) / vd_num_edges.squeeze(1).to(dist)
    ...
    def _compute_vd(self, x_nx3, surf_cubes_fx8, surf_edges, s_n, case_ids, beta_fx12, alpha_fx8, gamma_f, idx_map, grad_func):
        ...
        if grad_func is not None:
            ...
            beta_sum = torch.zeros((total_num_vd, 1), device=self.device, dtype=beta_fx12.dtype)
