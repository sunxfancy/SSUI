...
from backend.stable_diffusion.denoise_context import DenoiseContext, UNetKwargs
...
from backend.stable_diffusion.diffusion.shared_invokeai_diffusion import StableDiffusionBackendConfig
...
class StableDiffusionBackend:
    def __init__(
        ...
        config = StableDiffusionBackendConfig()
