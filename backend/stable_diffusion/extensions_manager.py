...
from ..util.original_weights_storage import OriginalWeightsStorage
...
if TYPE_CHECKING:
    ...
    from backend.stable_diffusion.extensions.base import CallbackFunctionWithMetadata, ExtensionBase


class ExtensionsManager:
    def __init__(self, is_canceled: Optional[Tuple[Callable[[], bool], Type[Exception]]] = (None, None)):
        self._is_canceled = is_canceled[0]
        self._exception = is_canceled[1]
