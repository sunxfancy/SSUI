...
model's config, as defined in backend.model_manager.config.
...
from backend.model_manager import ModelRepoVariant
from backend.model_manager.util.select_hf_files import filter_files
