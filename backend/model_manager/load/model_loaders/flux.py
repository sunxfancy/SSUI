...
"""Class for Flux model loading in """
...
from backend.flux.ip_adapter.state_dict_utils import infer_xlabs_ip_adapter_params_from_state_dict
from backend.flux.ip_adapter.xlabs_ip_adapter_flux import (
    XlabsIpAdapterFlux,
)
from backend.flux.model import Flux
from backend.flux.modules.autoencoder import AutoEncoder
from backend.flux.util import ae_params, params
...
try:
    ...
    from backend.quantization.bnb_nf4 import quantize_model_nf4
