...
from backend.model_manager import AnyModel, SubModelType
from backend.model_manager.load.memory_snapshot import MemorySnapshot
from backend.model_manager.load.model_cache.cache_record import CacheRecord
from backend.model_manager.load.model_cache.cache_stats import CacheStats
from backend.model_manager.load.model_cache.cached_model.cached_model_only_full_load import (
    CachedModelOnlyFullLoad,
)
from backend.model_manager.load.model_cache.cached_model.cached_model_with_partial_load import (
    CachedModelWithPartialLoad,
)
from backend.model_manager.load.model_cache.torch_module_autocast.torch_module_autocast import (
    apply_custom_layers_to_model,
)
from backend.model_manager.load.model_util import calc_model_size_by_data
...
class ModelCache:
    ...
    def _calc_ram_available_to_model_cache(self) -> int:
        ...
        # 1. As an initial default, use 50% of the total RAM for 
