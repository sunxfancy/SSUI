...
Usage:
```
from backend.model_manager.util.select_hf_files import select_hf_model_files
...
from backend.model_manager.config import ModelRepoVariant
...
def filter_files(
    ...
    as defined in `backend.model_manager.metadata.metadata_base`.
    """
