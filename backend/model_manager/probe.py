...
from backend.flux.ip_adapter.state_dict_utils import is_state_dict_xlabs_ip_adapter
from backend.model_hash.model_hash import HASHING_ALGORITHMS, ModelHash
...
from backend.model_manager.load.model_loaders.generic_diffusers import ConfigLoader
from backend.model_manager.util.model_util import (
    get_clip_variant_type,
    lora_token_vector_length,
    read_checkpoint_meta,
)
from backend.patches.lora_conversions.flux_control_lora_utils import is_state_dict_likely_flux_control
...
from backend.patches.lora_conversions.flux_onetrainer_lora_conversion_utils import (
    is_state_dict_likely_in_flux_onetrainer_format,
)
from backend.quantization.gguf.ggml_tensor import GGMLTensor
from backend.quantization.gguf.loaders import gguf_sd_loader
from backend.spandrel_image_to_image_model import SpandrelImageToImageModel
        ...
        if model_type is ModelType.Main:
            if base_type == BaseModelType.Flux:
                ...
                if (
                    ...
                    # For flux, this is a key in backend.flux.util.params
            ...
            config_file = (
                # For flux, this is a key in backend.flux.util.ae_params
                #   Due to model type and format being the descriminator for model configs this
                #   is used rather than attempting to support flux with separate model types and format
                #   If changed in the future, please fix me
                "flux"
